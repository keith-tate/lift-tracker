...
Two hard sets per movement, six movements per day, ~60 minutes, 90–120 sec rest.
...
- **Today** — day picker, warm-up block, the six move cards with live set-2 math, rest timer, log button
